...
with open("train.csv", "w") as f:			#first dictionary contains all 20k data including train and test , we have to separate it
    csv.writer(f).writerows(merged)		#refer to csv_separating.py
